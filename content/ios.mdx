...
- modular architecture multirepo
    ...
    - TanakhResources : as an independent framework with the responsibility of provide audio and JSon resources for the app
        - The App is currently getting big media files from Google Storage
            - in the event that in the future it becomes necessary to change to other Content Provider, like Amazon S3, Linode, etc. The impact should be minumum to the main App, ideally just a change in pod dependency name should be enough.
