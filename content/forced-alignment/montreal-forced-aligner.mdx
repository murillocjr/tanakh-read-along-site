...
### english
this sets the acoustic model to use during the alignment process, so we will use the anglish mmodel to match our english-phonemes. Maybe later, using all the matching words and phonemes times it would be interesting use MontrealFA to train an Hebrew model.
...
```bash
mfa align --clean t2601 t2601/t2601.dict english t2601_aligned
```
