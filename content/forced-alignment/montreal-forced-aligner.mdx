...
1. Script Utils to generate folders, lexicon-dict and json 
2. Trim audio so it matches the text, usually this means remove the initial segment containing the book and chapter.
